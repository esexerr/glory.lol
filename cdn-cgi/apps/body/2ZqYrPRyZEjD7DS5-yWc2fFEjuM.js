if (
  CloudflareApps.matchPage(CloudflareApps.installs["D2IMEjOyqLEV"].URLPatterns)
) {
  (function () {
    "use strict";
    ...
    var options = window.CloudflareApps.installs["D2IMEjOyqLEV"].options;
    ...
    function closeApp() {
      ...
      if ("D2IMEjOyqLEV" === "preview") updateVisibility();
    }
    function updateVisibility() {
      ...
      if ("D2IMEjOyqLEV" === "preview" || !stored) {
        visible = true;
      } else {
    ...
    window.CloudflareApps.installs["D2IMEjOyqLEV"].scope = {
