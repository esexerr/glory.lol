      ...
      t.map((i) => {
        ...
        if (!!s)
          for (let h = r.length - 1; h >= 0; h--) {
            const u = r[h];
            if (u.href === i && (!o || u.rel === "stylesheet")) return;
          }
        else if (document.querySelector(`link[href="${i}"]${a}`)) return;
        const l = document.createElement("link");
        if (
          ((l.rel = o ? "stylesheet" : tt),
...
const vt = "1.9.2",
  mt = { "X-Client-Info": `postgrest-js/${vt}` };
class we {
  constructor(e, { headers: t = {}, schema: s, fetch: r } = {}) {
    (this.url = e),
...
const yt = "2.9.3",
  wt = { "X-Client-Info": `realtime-js/${yt}` },
  bt = "1.0.0",
  Je = 1e4,
  kt = 1e3;
var z;
      ...
      this.map(o, (l, h) => {
        ...
        if (u) {
          const d = h.map((_) => _.presence_ref),
            ...
            g = h.filter((_) => p.indexOf(_.presence_ref) < 0),
            f = u.filter((_) => d.indexOf(_.presence_ref) < 0);
          g.length > 0 && (a[l] = g), f.length > 0 && (c[l] = f);
        } else a[l] = h;
      }),
...
const $e = (n, e, t = {}) => {
    ...
    return Object.keys(e).reduce((i, o) => ((i[o] = Tt(o, n, e, r)), i), {});
  },
  Tt = (n, e, t, s) => {
  ...
  Pt = (n) => (typeof n == "string" ? n.replace(" ", "T") : n);
var je;
(function (n) {
  (n.ALL = "*"),
    (n.INSERT = "INSERT"),
          ...
          .receive("ok", ({ postgres_changes: l }) => {
            ...
            if (
              ...
              for (let g = 0; g < d; g++) {
                const f = u[g],
                  {
                    filter: { event: _, schema: w, table: b, filter: O },
                  } = f,
                  k = l && l[g];
                if (
                  k &&
              ...
              if ("id" in p) {
                ...
                return (
                  ...
                  ((f = t.ids) === null || f === void 0
                    ...
                    : f.includes(k)) &&
                  (ee === "*" ||
                    (ee == null ? void 0 : ee.toLocaleLowerCase()) ===
                ...
                const k =
                  (b =
                    (w = p == null ? void 0 : p.filter) === null || w === void 0
                      ? void 0
...
class Ct {
  constructor(e, t) {
    ...
    r && ((this.accessToken = r), (this.apiKey = r)),
      ...
      (this.reconnectTimer = new Me(async () => {
  ...
  connect() {
    if (!this.conn) {
      ...
      (this.conn = new xt(this._endPointURL(), void 0, {
        close: () => {
          this.conn = null;
        },
      })),
        K(
          () => import("./browser.06aa05b2.js").then((e) => e.b),
          [],
          import.meta.url
        ).then(({ default: e }) => {
  ...
  _endPointURL() {
    return this._appendParams(
      this.endPoint,
      Object.assign({}, this.params, { vsn: bt })
    );
  }
  _onConnMessage(e) {
...
const Jt = "2.5.5",
  Mt = { "X-Client-Info": `storage-js/${Jt}` };
var D =
  (globalThis && globalThis.__awaiter) ||
  function (n, e, t, s) {
    function r(i) {
...
typeof Deno < "u"
  ...
  ? (W = "react-native")
  : (W = "node");
const Ht = { "X-Client-Info": `supabase-js-${W}/${Gt}` },
  Vt = { headers: Ht },
  Wt = { schema: "public" },
  Yt = {
    autoRefreshToken: !0,
...
const Zt = (n) => {
  ...
  es = () => (typeof Headers > "u" ? Be : Headers),
  ts = (n, e, t) => {
    const s = Zt(t),
      r = es();
    return (i, o) =>
...
const M = (n) =>
  ...
  vs = [502, 503, 504];
async function Le(n) {
  if (!os(n)) throw new ve(M(n), 0);
  if (vs.includes(n.status)) throw new ve(M(n), n.status);
  let e;
  try {
    e = await n.json();
  } catch (t) {
  ...
  throw typeof e == "object" &&
    ...
    ? new gs(M(e), n.status, e.weak_password.reasons)
    : new fs(M(e), n.status || 500);
}
const ms = (n, e, t, s) => {
  const r = { method: n, headers: (e == null ? void 0 : e.headers) || {} };
  return n === "GET"
...
async function ys(n, e, t, s, r, i) {
  const o = ms(e, s, r, i);
  let a;
  try {
    a = await n(t, o);
  } catch (c) {
    throw (console.error(c), new ve(M(c), 0));
  }
  if ((a.ok || (await Le(a)), s != null && s.noResolveJson)) return a;
  try {
    return await a.json();
  } catch (c) {
    await Le(c);
...
function I(n) {
  ...
  Ss(n) &&
    ((t = Object.assign({}, n)),
    n.expires_at || (t.expires_at = is(n.expires_in)));
  ...
  async listUsers(e) {
    ...
    try {
      ...
      return (
        p.length > 0 &&
          (p.forEach((g) => {
            const f = parseInt(g.split(";")[0].split("=")[1].substring(0, 1)),
...
const We = "0.0.0",
  ...
  js = { "X-Client-Info": `gotrue-js/${We}` },
  De = 10,
  Ps = {
    getItem: (n) => (Q() ? globalThis.localStorage.getItem(n) : null),
    setItem: (n, e) => {
      Q() && globalThis.localStorage.setItem(n, e);
    },
    removeItem: (n) => {
      Q() && globalThis.localStorage.removeItem(n);
    },
  };
function Ne(n = {}) {
  return {
...
class X {
  constructor(e) {
    ...
    const r = Object.assign(Object.assign({}, xs), e);
    if (
      ...
      (this.admin = new Os({ url: r.url, headers: r.headers, fetch: r.fetch })),
      (this.url = r.url),
  ...
  async _signOut({ scope: e } = { scope: "global" }) {
    return await this._useSession(async (t) => {
      ...
      if (o) {
        ...
        if (a && !(ps(a) && (a.status === 404 || a.status === 401)))
          return { error: a };
      }
      return (
        e !== "others" &&
  ...
  async _handleVisibilityChange() {
    if (
      ...
      !$() || !(window != null && window.addEventListener))
    )
...
class Us {
  constructor(e, t, s) {
    ...
    const p = `sb-${new URL(this.authUrl).hostname.split(".")[0]}-auth-token`,
      g = {
        db: Wt,
        realtime: Qt,
        auth: Object.assign(Object.assign({}, Yt), { storageKey: p }),
        global: Vt,
      },
      f = rs(s ?? {}, g);
    (this.storageKey =
  ...
  get storage() {
    return new Kt(this.storageUrl, this.headers, this.fetch);
  }
  from(e) {
...
var Ns = Object.create,
  ...
  Js = (n, e) =>
    function () {
      return n && (e = (0, n[Te(n)[0]])((n = 0))), e;
    },
  Ms = (n, e) =>
    function () {
      return e || (0, n[Te(n)[0]])((e = { exports: {} }).exports, e), e.exports;
    },
  zs = (n, e, t, s) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (let r of Te(e))
        !Bs.call(n, r) &&
          ...
          Qe(n, r, {
            get: () => e[r],
            enumerable: !(s = Fs(e, r)) || s.enumerable,
          });
    return n;
  },
  Xe = (n, e, t) => (
    ...
    zs(
      e || !n || !n.__esModule
        ? Qe(t, "default", { value: n, enumerable: !0 })
        : t,
      n
    )
  ),
  ...
  Ze = Ms({
    "../../node_modules/.pnpm/cookie@0.5.0/node_modules/cookie/index.js"(n) {
      ...
      function s(l, h) {
        ...
        for (
          ...
          if (_ === -1) _ = l.length;
            ...
            g = l.lastIndexOf(";", f - 1) + 1;
            continue;
          }
          var w = l.slice(g, f).trim();
          if (u[w] === void 0) {
            var b = l.slice(f + 1, _).trim();
      ...
      function r(l, h, u) {
        ...
        var g = p(h);
        if (g && !t.test(g)) throw new TypeError("argument val is invalid");
        var f = l + "=" + g;
        if (d.maxAge != null) {
          var _ = d.maxAge - 0;
          if (isNaN(_) || !isFinite(_))
            throw new TypeError("option maxAge is invalid");
          f += "; Max-Age=" + Math.floor(_);
        }
        if (d.domain) {
          if (!t.test(d.domain))
 ...
 * MIT Licensed
 */ const Ws = "@supabase/auth-helpers-sveltekit",
  Ys = "0.8.7";
function Qs(n, e, t, s) {
  var o;
  const r = {
    ...
    i = Vs({ supabaseUrl: n, supabaseKey: e, options: r, cookieOptions: s });
  return { maxAge: 1e3 * 60 * 60 * 24 * 365, ...s }, i;
}
const Xs =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBsZ296dG5vbmxtcmNjZHVrdXhvIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzIzNjYxMDcsImV4cCI6MTk4Nzk0MjEwN30.7vcVTdFDSlbYml-uxjdxgYYGyR-qyFd8I6w7Ld6jxQg",
  Zs = "https://plgoztnonlmrccdukuxo.supabase.co",
  er = Qs(Zs, Xs);
export { K as _, er as s };
